          ...
          <div class="container h-50">
            ...
            ">
                        <div class="card-body p-5 shadow-5 text-center">
                          <h2 class="fw-bold mb-5">Cadastro de Consultas</h2>
                          <form action="/appointment/edit/${appointment.id}" method="POST">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6 mb-4">
                                <div class="btn-group" id="check-group">
                                  <c:choose>
                                    <c:when test="${appointment.level == 'NORMAL'}">
                                      <input type="radio" class="btn-check" name="level" id="option1" value="NORMAL"
                                        autocomplete="off" checked />
                                      <label class="btn btn-secondary" for="option1">Normal</label>

                                      <input type="radio" class="btn-check" name="level" id="option2" value="EMERGENCY"
                                        autocomplete="off" />
                                      <label class="btn btn-secondary" for="option2">Emergência</label>
                                    </c:when>
                            ...
                            <div class="row">
                              <a class="small text-muted" href="/appointment">Cancelar e voltar</a>
                            </div>
                          </form>
                        </div>
                      </div>
