                                        ...
                                        <div class="card-body p-4 p-lg-5 text-black">
                                            ...
                                            <form action="/login" method="POST">
                                                ...
                                                <div class="d-flex align-items-center mb-3 pb-1">
                                                    <i class="fas fa-paw fa-2x me-3" style="color: #2b7bc6;"></i>
                                                    <span class="h1 fw-bold mb-0">PetCare</span>
                                                </div>

                                                <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Entre com
                                                    sua
                                                    conta</h5>
                                                ...
                                                <p class="mb-5 pb-lg-2" style="color: #393f81;">Não tem conta? <a
                                                        href="user/register" style="color: #393f81;">Cadastre-se
                                                        aqui</a>
                                                </p>
